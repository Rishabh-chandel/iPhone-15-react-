    ...
    useGSAP(() => {
        gsap.to('#exploreVideo' , {
            scrollTrigger: {
                ...
                toggleActions: "play pause reverse restart", /// modifactions
                start: '-10% bottom',
            },
            onComplete: () => {
        ...
        animate('#feature-title' , {y:0, opacity:1})
        animate('.g_grow',
        ...
        animate(
            ".g_text",
            {y:0, opacity: 1, ease: 'power2.intOut',duration:1}
        )
    },[]);
